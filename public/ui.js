...
LinvoDB.Models = {
    ...
    Preset: new LinvoDB('preset', {
        ...
        description: {type: String, default: 'A new preset...'},
        type: {type: String, default: 'custom'},
        options: {
            outputFormat: {type: String, default: 'mkv'},
            nativeLanguage: {type: String, default: 'English'},
            destination: {type: String, default: OS.homedir()},
            preview: {type: Boolean, default: false},
            screenshots: {type: Boolean, default: false},
            delete: {type: Boolean, default: false},
            previewLength: {type: Number, default: 30000},
            normalizationLevel: {type: Number, default: 1},
            quality: {type: Number, default: 20},
            videoBitrate: {type: Number, default: 0},
            preset: {type: String, default: 'fast'},
            extraOptions: {type: String, default: ""},
            heAudio: {type: Boolean, default: false},
            forceHeAudio: {type: Boolean, default: false},
            downmixHeAudio: {type: Boolean, default: false},
            override: {type: Boolean, default: false},
            accurateTimestamps: {type: Boolean, default: false},
            upconvert: {type: Boolean, default: true}
        }
    }, {})
};
const Models = LinvoDB.Models;
Models.Setting.findOne({name: 'theme'}, function (err, doc) {
    if (err) {
        console.error(err);
    }
    let settings = {};
                ...
                $rootScope.tour = new Tour({
                    steps: [
                        ...
                        },
                        {
                            ...
                            text: `Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nunc quis commodo mi, sed bibendum orci. Quisque pellentesque turpis in mi posuere, eget fermentum urna scelerisque.
Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nunc quis commodo mi, sed bibendum orci. Quisque pellentesque turpis in mi posuere, eget fermentum urna scelerisque.
Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nunc quis commodo mi, sed bibendum orci. Quisque pellentesque turpis in mi posuere, eget fermentum urna scelerisque.
Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nunc quis commodo mi, sed bibendum orci. Quisque pellentesque turpis in mi posuere, eget fermentum urna scelerisque.
Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nunc quis commodo mi, sed bibendum orci. Quisque pellentesque turpis in mi posuere, eget fermentum urna scelerisque.
Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nunc quis commodo mi, sed bibendum orci. Quisque pellentesque turpis in mi posuere, eget fermentum urna scelerisque.
...
Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nunc quis commodo mi, sed bibendum orci. Quisque pellentesque turpis in mi posuere, eget fermentum urna scelerisque.`,
            ...
            .controller('encoderSettingsCtrl', function ($scope, videosManager) {
            ...
            .controller('preferencesCtrl', function ($scope, $mdDialog) {
                ...
                $scope.saveOnChange = function (modelName) {
                    $scope.$watch(modelName, function (cur) {
                        ...
                        Models.Setting.update({name: modelName}, {name: modelName, value: cur}, {upsert: true});
                    });
                };
            ...
            .controller('addVideosCtrl', function ($scope, videosManager, $rootScope, asPresetManager, $element) {
                ...
                $scope.addFilesToQueue = function () {
                    ...
                    for (let vid of $scope.videosManager.beingAdded) {
                        vid.options = $scope.clonedOptions;
            ...
            .factory('videosManager', function ($rootScope, logger) {
                ...
                let update = function () {
                    _.each(listeningScopes, function (scopeSet) {
                        let scope = scopeSet[0], obj = scopeSet[1];
                        scope.$applyAsync(function () {
...
//                    let video = new h265ize.Video('D:\\Users\\Ayrton\\Downloads\\ocean.mp4');
//                    f.addVideo(video);
//                }
